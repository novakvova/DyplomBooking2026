...
import HousingGridCard from "../components/HousingList/HousingGridCard";
              ...
              >
                {Array.from({
                  ...
                  <div
                    ...
                    className={
                      viewMode === "grid"
                        ? "h-[360px] animate-pulse rounded-[16px] bg-slate-100"
                        : "h-[260px] animate-pulse rounded-[16px] bg-slate-100"
                    }
                  />
                ))}
              </div>
